...
(defn result [noun verb]
  (nth (transform-matrix (values noun verb)) 0))
...
(defn find-value [value]
    (for [x (range 99)
          ...
          :let [noun x
                verb y]
          :when (= value (result x y))]
     {:noun noun :verb verb}))

(defn -main
  "I don't do a whole lot ... yet."
  [& args]
  (println "Result is " (find-value 19690720)))
